...
<b>ɪɴᴛʀᴏᴅᴜᴄɪɴɢ @Uchitra_probot, ᴄʀᴀғᴛᴇᴅ ʙʏ @UncountableAura! ᴜᴛɪʟɪᴢᴇ ɪᴛs sᴇᴀᴍʟᴇss ғᴇᴀᴛᴜʀᴇs ᴛᴏ ᴘʟᴀʏ ʏᴏᴜʀ ғᴀᴠᴏʀɪᴛᴇ sᴏɴɢs, ᴡɪᴛʜ ᴍᴀɴʏ ᴍᴏʀᴇ ᴇxᴄɪᴛɪɴɢ ғᴇᴀᴛᴜʀᴇs ᴏɴ ᴛʜᴇ ᴡᴀʏ. sᴛᴀʏ ᴛᴜɴᴇᴅ ᴀɴᴅ Jᴏɪɴ @BeAkatsuki ! ғᴏʀ ᴛʜᴇ ʟᴀᴛᴇsᴛ ᴜᴘᴅᴀᴛᴇs! ʜᴇʜᴇ, ᴛʜᴀɴᴋ ᴍᴇ ʟᴀᴛᴇʀ... ʙʏᴇᴇ!</b>
"""
HELP_17 = """
<b><u>𝖬𝗈𝖽𝖾𝗋𝖺𝗍𝗈𝗋𝗌 :</b></u>
